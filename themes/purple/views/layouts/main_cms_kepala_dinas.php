	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				Dinas Perhubungan Kota Medan | Kepala Dinas
				</a>       
	...
	<div class="page-container row-fluid">
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul>
				...
				<li><a href="<?php echo Yii::app()->baseUrl; ?>/kepala_dinas">Dashboard</a></li>
				<li><a href="<?php echo Yii::app()->baseUrl; ?>/kepala_dinas_info_pemenang">Info Pemenang Pengadaan</a></li>
				<li><a href="<?php echo Yii::app()->baseUrl; ?>/kepala_dinas_info_pad">Info Pendapatan Asli Daerah</a></li>
				<li><a href="<?php echo Yii::app()->baseUrl; ?>/site/logout">Log Out</a></li>
			</ul>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4>Dinas Perhubungan Kota Medan | Kepala Dinas</h4>
							</div>
