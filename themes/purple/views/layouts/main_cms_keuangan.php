	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				Dinas Perhubungan Kota Medan | Keuangan
				</a>       
	...
	<div class="page-container row-fluid">
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul>
				...
				<li><a href="<?php echo Yii::app()->baseUrl; ?>/keuangan">Dashboard</a></li>
				<li><a href="<?php echo Yii::app()->baseUrl; ?>/keuangan_target">Manajemen Target</a></li>
				<li><a href="<?php echo Yii::app()->baseUrl; ?>/keuangan_penerimaan">Manajemen Penerimaan</a></li>
				<li><a href="<?php echo Yii::app()->baseUrl; ?>/site/logout">Log Out</a></li>
			</ul>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4>Dinas Perhubungan Kota Medan | Keuangan</h4>
							</div>
