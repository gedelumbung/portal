 ...
 * @property string $nama_pemenang_1
 * @property string $nilai_penawaran_1
 * @property string $npwp_1
 * @property string $nama_pemenang_2
 * @property string $nilai_penawaran_2
 * @property string $npwp_2
 * @property string $nama_pemenang_3
 * @property string $nilai_penawaran_3
 * @property string $npwp_3
 */
class PemenangPengadaan extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PemenangPengadaan the static model class
	 */
