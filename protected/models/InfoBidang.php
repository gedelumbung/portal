 ...
 */
class InfoBidang extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return InfoBidang the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_info, judul, isi, tanggal, id_user, id_bidang, stts', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		if(!empty(Yii::app()->user->id_bidang) && !Yii::app()->user->isGuest)
		{
			$criteria->condition = "id_bidang = '".Yii::app()->user->id_bidang."'";
