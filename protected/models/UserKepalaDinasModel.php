...
/**
 * This is the model class for table "tbl_user_kepala_dinas".
 *
 * The followings are the available columns in table 'tbl_user_kepala_dinas':
 ...
 */
class UserKepalaDinasModel extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return UserKepalaDinasModel the static model class
	 */
