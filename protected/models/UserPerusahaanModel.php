 ...
 */
class UserPerusahaanModel extends CActiveRecord
{
	public $verifyCode;
	 ...
	 * @return UserPerusahaanModel the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('nama, username, password, level, email, stts, verifyCode', 'required'),
			array('nama, username, password', 'length', 'max'=>100),
			array('level', 'length', 'max'=>20),
			array('email', 'length', 'max'=>50),
			array('email', 'email'),
			array('verifyCode', 'captcha', 'allowEmpty'=>!CCaptcha::checkRequirements()),
			array('stts', 'length', 'max'=>75),
